...
// success()
 ...
 acura.start()
 acura.pickUp('dayah')
 assert.strictEqual(acura.pickUp('dayah'), true, 'start() not working')
 success()

 console.log('Testing dropOff')
 acura.start()
 acura.dropOff('dayah')
 assert.strictEqual(acura.dropOff('dayah'), true, 'dropOff() not working')
 success()

 console.log('TestingpassengerCount()')
 acura.passengerCount()
 assert.strictEqual(Number.isInteger(acura.passengerCount()), true, 'passengerCount() not working')
 success()
